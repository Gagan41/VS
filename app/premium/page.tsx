            ...
            <main className="max-w-7xl mx-auto pb-20">
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-gray-200 pb-10">
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-5xl font-black text-black leading-tight">Premium Content</h1>
                        <p className="text-gray-700 text-lg font-medium">Exclusive high-fidelity content for our active members.</p>
                    </div>
