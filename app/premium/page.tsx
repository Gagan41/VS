            ...
            <main className="max-w-7xl mx-auto pb-20">
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-gray-200 pb-10">
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-5xl font-black text-black dark:text-white leading-tight">Premium Content</h1>
                        <p className="text-gray-700 dark:text-gray-400 text-lg font-medium">Exclusive high-fidelity content for our active members.</p>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        <p className="text-gray-600 text-lg">No premium videos available yet.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
